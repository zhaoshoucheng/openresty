#define NGX_CONFIGURE " --prefix=/data/pkg/openresty/nginx --with-cc-opt=-O2 --add-module=../ngx_devel_kit-0.3.1rc1 --add-module=../echo-nginx-module-0.61 --add-module=../xss-nginx-module-0.06 --add-module=../ngx_coolkit-0.2 --add-module=../set-misc-nginx-module-0.32 --add-module=../form-input-nginx-module-0.12 --add-module=../encrypted-session-nginx-module-0.08 --add-module=../srcache-nginx-module-0.31 --add-module=../ngx_lua-0.10.15 --add-module=../ngx_lua_upstream-0.07 --add-module=../headers-more-nginx-module-0.33 --add-module=../array-var-nginx-module-0.05 --add-module=../memc-nginx-module-0.19 --add-module=../redis2-nginx-module-0.15 --add-module=../redis-nginx-module-0.3.7 --add-module=../rds-json-nginx-module-0.15 --add-module=../rds-csv-nginx-module-0.09 --add-module=../ngx_stream_lua-0.0.7 --with-ld-opt=-Wl,-rpath,/data/pkg/openresty/luajit/lib --user=nginx --group=nginx --with-http_v2_module --with-http_sub_module --with-http_realip_module --with-http_stub_status_module --add-module=/data/openresty/other_nginx_bundles/nginx-sticky-module-ng --add-module=/data/openresty/other_nginx_bundles/nginx_upstream_check_module --add-module=/data/openresty/other_nginx_bundles/ngx_stream_upstream_check_module --with-openssl=/data/openresty/other_nginx_bundles/openssl/1.1.0k --with-pcre=/data/openresty/other_nginx_bundles/pcre/pcre-8.39 --with-zlib=/data/openresty/other_nginx_bundles/zlib/zlib-1.2.10 --with-stream --with-stream_ssl_module --with-stream_ssl_preread_module --with-http_ssl_module"
...
#ifndef NGX_STREAM_UPSTREAM_CHECK
#define NGX_STREAM_UPSTREAM_CHECK  1
#endif
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/data/pkg/openresty/nginx/"
#endif
